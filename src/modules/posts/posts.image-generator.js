...
function buildImagePrompt({ title, subtitle, content, contentHtml, categoryName, tagNames }) {
    ...
    return [
        ...
        'Style: premium DevOps editorial cover art, dark atmospheric background, cinematic lighting, crisp contrast, polished 3D-inflected illustration, professional magazine-like composition.',
        'Visual language: deep navy and slate surfaces with electric cyan, azure, and amber highlights, similar to modern AI-generated infrastructure cover art.',
        ...
        'Favor elegant scene-building over flat screenshots: racks, nodes, control planes, glowing terminals, network paths, cloud layers, secure gateways, and cinematic volumetric light when appropriate.',
